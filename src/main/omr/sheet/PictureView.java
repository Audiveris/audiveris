    ...
    extends ScrollView
{
    ...
    //-------//
    /**
     * Close the view, by removing it from the containing sheet tabbed pane.
     */
    public void close ()
    {
    ...
    //------------------//
    /**
     * If the sheet-related score exists, then display the score view in the
     * score display. Focus is determined as the corresponding point in
