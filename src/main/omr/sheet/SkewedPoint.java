...
/**
 * Class <code>SkewedPoint</code> is a simple Point that is meant to
 * represent a point in the original image : a raw, probably skewed page,
 * with its coordinates specified in pixels.
 *
