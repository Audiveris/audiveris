...
/**
 * Class <code>CheckPanel</code> handles a panel to display the results of
 * a check suite.
 *
...
public class CheckPanel <C extends Checkable>
{
    ...
    //----------//
    /**
     * Pass the whole suite on the provided checkable object, and display
     * the results
     *
    ...
    private void buildComponent()
    {
        ...
        PanelBuilder b = new PanelBuilder(createLayout(checkNb),
                                          component);
        ...
        for (Check check : suite.getChecks()) {
            ...
            // Weight label
            JLabel weightLabel =
                new JLabel(String.format("%s", suite.getWeights().get(ic).intValue()));
            ...
            JLabel lowLabel = new JLabel(String.format("%5.2f", check.getLow()));
            lowLabel.setToolTipText("Lower limit of orange zone");
            b.add(lowLabel,             c.xy( 9, r));

            b.add(values[ic][1],                                c.xy(11, r));

            JLabel highLabel = new JLabel(String.format("%5.2f", check.getHigh()));
    ...
    private FormLayout createLayout(int checkNb)
    {
        ...
        sbc.append("center:pref").append(", ").append(COLUMN_GAP).append(", "); // Weight
        sbc.append(" right:46dlu").append(", ").append(COLUMN_GAP).append(", "); // Name
        ...
        return new FormLayout(sbc.toString(), //cols
                              sbr.toString());//rows
