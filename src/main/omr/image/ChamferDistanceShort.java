//----------------------------------------------------------------------------//
//                                                                            //
//                   C h a m f e r D i s t a n c e S h o r t                  //
//                                                                            //
//----------------------------------------------------------------------------//
...
/**
 * Class {@code ChamferDistanceShort} implements a Distance
 * Transform operation using chamfer masks.
 *
 * @author Code by Xavier Philippeau <br> Kernels by Verwer, Borgefors and Thiel
 * @author Hervé Bitteur for a pure short version
 */
public class ChamferDistanceShort
{
    ...
    //~ Constructors -----------------------------------------------------------
    //----------------------//
    // ChamferDistanceShort //
    //----------------------//
    /**
     * Creates a new ChamferDistanceShort object, with chamfer3
     * as default mask.
     */
    public ChamferDistanceShort ()
    {
        this(ChamferDistanceShort.chamfer3);
    }
    ...
    //----------------------//
    /**
     * Creates a new ChamferDistanceShort object, using provided mask.
     *
     * @param chamfer the desired chamfer mask
     */
    public ChamferDistanceShort (int[][] chamfer)
    {
     ...
     */
    public short[][] compute (boolean[][] input)
    {
     ...
     *         distance to the nearest reference pixel
     */
    public short[][] computeToBack (PixelBuffer input)
    {
     ...
     *         distance to the nearest reference pixel
     */
    public short[][] computeToFore (PixelBuffer input)
    {
        final int width = input.getWidth();
        final int height = input.getHeight();
     ...
     */
    private void process (short[][] output)
    {
    ...
    // testAndSet //
    //------------//
    private void testAndSet (short[][] output,
                             int x,
                             int y,
                             int newvalue)
    {
