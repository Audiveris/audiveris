 ...
 *
 * <p/> To be activated, this class must be explicitly listed as a
 * handler in the logging configuration file.
 *
    ...
    extends java.util.logging.Handler
{
    ...
    //-------//
    /**
     * Called when the handler must be closed. It's a void routine for the
     * time being.
     */
    public void close ()
    {
