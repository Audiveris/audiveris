...
/**
 * Class {@code BeamHookPattern} removes beam hooks for which the related stem has no
 * beam on the same horizontal side of the stem and on the same vertical end of the stem.
 *
