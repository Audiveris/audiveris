    ...
    implements Comparable<Sentence>
{
    ...
    private boolean areInSameSentence (Glyph g1,
                                       Glyph g2)
    {
        int x1 = g1.getTextStart().x;
        int x2 = g2.getTextStart().x;
    ...
    private TextType guessType ()
    {
        ...
        case within : // Name, Lyric, Direction
