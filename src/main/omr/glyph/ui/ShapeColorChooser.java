...
/**
 * Class <code>ShapeColorChooser</code> offers a convenient user interface
 * to choose proper color for each glyph shape. It is derived from the Sun
 * Java tutorial ColorChooserDemo.
 *
 * <p>The lower part of the panel is used by a classic color chooser
 *
 * <p>The upper part of the panel is used by the shape at hand, with a way
 * to browse through the various defined shapes.
 *
 * <p>The strategy is the following: First the predefined shape ranges
 * (such as "Physicals", "Bars", "Clefs", ...) have their own color
    ...
    implements ChangeListener
{
    ...
    //-------------------//
    /**
     * Create an instance of ShapeColorChooser (should be improved to
     * always reuse the same instance. TBD)
     */
        ...
        extends Pane
    {
        ...
        public void setRange ()
        {
            ...
            selectButton.setText("-- Select Shape from " +
                                 ranges.current.getName() + " --");
        ...
        private void buildShapesMenu()
        {
            ...
            Shape.addRangeShapeItems(ranges.current, menu,
                                     selectionListener);
        }
        ...
        private void prepareSpecificOption()
        {
            ...
            if (chosenColor != null) {
                paste.setEnabled
                    (chosenColor != ranges.current.getColor());
            } else {
                paste.setEnabled(false);
            }
        }
