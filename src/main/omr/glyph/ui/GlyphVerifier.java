...
/**
 * Class <code>GlyphVerifier</code> provides a user interface to browse
 * through all glyphs recorded for evaluator training, and allow to
 * visually check the correctness of their assigned shape.
 *
...
//        = new EvaluatorsPanel(null, null);
    ...
    //--------//
    /**
     * Focus the verifier on a provided collection of glyphs (typically,
     * such glyphs that are not recognized, or mistaken, by the evaluators)
     *
    ...
    {
        protected List list = new List(/* rows => */ 5,
                                       /* multipleMode => */ true);
        ...
        protected JLabel cardinal = new JLabel("* No item selected *",
        ...
        extends JPanel
    {
        ...
        // Glyph designated by simple mouse pointing. This is just a trick
        // to highlight the glyph. See index variable instead.
        Glyph pointedGlyph;

        // This defines the current glyph, designated by whatever means. It
        // is an index in the 'names' array.
        int glyphIndex;
            ...
            extends Panel
        {
            JTextField name = new SField
                (false, "File where glyph is stored");
        ...
        private void deleteGlyph()
        {
            ...
            System.arraycopy(old, glyphIndex+1,
                             names, glyphIndex,
