...
/**
 * Class <code>ComputingVisitor</code> visits the score hierarchy to fix
 * internal data.
 ...
 * @version $Id$
 */
public class ComputingVisitor
    implements Visitor
{
    //~ Static fields/initializers ---------------------------------------------

    private static final Logger logger = Logger.getLogger(
        ComputingVisitor.class);

    //~ Constructors -----------------------------------------------------------

    /**
     * Creates a new ComputingVisitor object.
     */
    public ComputingVisitor ()
    {
    }
