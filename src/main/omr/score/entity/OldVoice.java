 ...
 */
public class OldVoice
{
    //~ Static fields/initializers -----------------------------------------------------------------

    private static final Logger logger = LoggerFactory.getLogger(OldVoice.class);
     ...
     */
    public OldVoice (OldChord chord)
    {
     ...
     */
    public static OldVoice createWholeVoice (OldChord wholeChord)
    {
        OldVoice voice = new OldVoice(wholeChord);
     ...
     */
    public OldChord getChordBefore (OldSlot slot)
    {
    ...
    //--------------------------//
    /**
     * Report the time signature value that can be inferred from the content of this voice.
     *
     ...
     */
    public OldChord getPreviousChord (OldChord chord)
    {
     ...
     */
    public VoiceChord getSlotInfo (OldSlot slot)
    {
     ...
     * @return true if free
     */
    public boolean isFree (OldSlot slot)
    {
     ...
     */
    public void setSlotInfo (OldSlot slot,
        ...
        if (wholeChord != null) {
            ...
            for (OldSlot slot : measure.getSlots()) {
                ...
                if (info != null) { // Active chord => busy
                    ...
                    if (info.getStatus() == Status.BEGIN) {
                        sb.append("|Ch#").append(String.format("%02d", info.getChord().getId()));
                    } else { // CONTINUE
                        sb.append("======");
                    }
    ...
    public static class VoiceChord
    {
        ...
        //~ Constructors ---------------------------------------------------------------------------
        public VoiceChord (OldChord chord,
                           Status status)
        {
            this.chord = chord;
            this.status = status;
