 ...
 */
public class OldStaff
        extends PartNode
{
    //~ Static fields/initializers -----------------------------------------------------------------

    private static final Logger logger = LoggerFactory.getLogger(OldStaff.class);
            ...
            implements Iterator<OldStaff>
    {
        ...
        //~ Constructors ---------------------------------------------------------------------------
        public PartIterator (OldMeasure measure)
        {
        ...
        @Override
        public OldStaff next ()
        {
            return (OldStaff) staffIterator.next();
        }
            ...
            implements Iterator<OldStaff>
    {
        ...
        // Non constant
        private OldSystemPart part;

        private OldMeasure measure;

        private PartIterator partStaffIterator;

        //~ Constructors ---------------------------------------------------------------------------
        public SystemIterator (OldMeasure measure)
        {
        ...
        {
            part = (OldSystemPart) partIterator.next();
            measure = (OldMeasure) part.getMeasures().get(measureIndex);
