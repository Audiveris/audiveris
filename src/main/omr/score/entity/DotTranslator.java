...
/**
 * Class <code>DotTranslator</code> is in charge of assigning a dot glyph, since
...
public class DotTranslator
{
    ...
    private static final Logger logger = Logger.getLogger(DotTranslator.class);
