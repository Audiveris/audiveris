...
public enum SectionRole
{
    ...
    /**
     * Flags an section, which is adjacent to a stick and to a crossing
     * object
     */
    INTERNAL (blue),
    ...
    /**
     * No stick member: Section too far from the median line of the stick to
     * be part of it
     */
    TOO_FAR (null),

    /**
     * No stick member: Section not slim enough to be considered in the
