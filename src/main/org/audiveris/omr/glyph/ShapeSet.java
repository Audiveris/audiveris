...
public class ShapeSet
{
     ...
     */
    public static final List<Shape> PartialTimes = Arrays.asList(TIME_TWO, TIME_THREE, TIME_FOUR,
                                                                 TIME_FIVE, TIME_SIX, TIME_SEVEN,
                                                                 TIME_EIGHT, TIME_NINE, TIME_TWELVE,
                                                                 TIME_SIXTEEN);
    ...
    public static final EnumSet<Shape> WholeTimes = EnumSet
            .of(COMMON_TIME, CUT_TIME, TIME_FOUR_FOUR, TIME_TWO_TWO, TIME_TWO_FOUR, TIME_THREE_FOUR,
                TIME_FIVE_FOUR, TIME_THREE_EIGHT, TIME_SIX_EIGHT);

    /** All sorts of F clefs */
    public static final EnumSet<Shape> BassClefs = EnumSet.of(F_CLEF, F_CLEF_SMALL, F_CLEF_8VA,
                                                              F_CLEF_8VB);

    /** All sorts of G clefs */
    public static final EnumSet<Shape> TrebleClefs = EnumSet.of(G_CLEF, G_CLEF_SMALL, G_CLEF_8VA,
                                                                G_CLEF_8VB);

    /** All flags down */
    public static final EnumSet<Shape> FlagsDown = EnumSet
            .of(FLAG_1, FLAG_2, FLAG_3, FLAG_4, FLAG_5);

    /** Small flags */
    public static final EnumSet<Shape> SmallFlags = EnumSet.of(SMALL_FLAG, SMALL_FLAG_SLASH);

    /** All flags up */
    public static final EnumSet<Shape> FlagsUp = EnumSet.of(FLAG_1_UP, FLAG_2_UP, FLAG_3_UP,
                                                            FLAG_4_UP, FLAG_5_UP);

    /** All SHARP-based keys */
    public static final EnumSet<Shape> SharpKeys = EnumSet.of(KEY_SHARP_1, KEY_SHARP_2, KEY_SHARP_3,
                                                              KEY_SHARP_4, KEY_SHARP_5, KEY_SHARP_6,
                                                              KEY_SHARP_7);

    /** All FLAT-based keys */
    public static final EnumSet<Shape> FlatKeys = EnumSet.of(KEY_FLAT_1, KEY_FLAT_2, KEY_FLAT_3,
                                                             KEY_FLAT_4, KEY_FLAT_5, KEY_FLAT_6,
                                                             KEY_FLAT_7);

    /** All black note heads */
    public static final EnumSet<Shape> BlackNoteHeads = EnumSet.of(NOTEHEAD_BLACK,
                                                                   NOTEHEAD_BLACK_SMALL);

    /** All void note heads */
    public static final EnumSet<Shape> VoidNoteHeads = EnumSet
            .of(NOTEHEAD_VOID, NOTEHEAD_VOID_SMALL);

    /** All supported small notes. (for cue/grace) */
    public static final EnumSet<Shape> SmallNotes = EnumSet.of(NOTEHEAD_BLACK_SMALL,
                                                               NOTEHEAD_VOID_SMALL, WHOLE_NOTE_SMALL);

    /** All heads without a stem. */
    public static final EnumSet<Shape> StemLessHeads = EnumSet.of(BREVE, WHOLE_NOTE,
                                                                  WHOLE_NOTE_SMALL);

    /** All heads with a stem. */
    public static final EnumSet<Shape> StemHeads = EnumSet.of(NOTEHEAD_BLACK, NOTEHEAD_BLACK_SMALL,
                                                              NOTEHEAD_VOID, NOTEHEAD_VOID_SMALL);

    /** All heads. */
    public static final List<Shape> Heads = Arrays.asList(BREVE, WHOLE_NOTE, WHOLE_NOTE_SMALL,
                                                          NOTEHEAD_BLACK, NOTEHEAD_BLACK_SMALL,
                                                          NOTEHEAD_VOID, NOTEHEAD_VOID_SMALL);
    ...
    public static final EnumSet<Shape> CoreBarlines = EnumSet.copyOf(Arrays.asList(THICK_BARLINE,
                                                                                   THICK_CONNECTOR,
                                                                                   THIN_BARLINE,
                                                                                   THIN_CONNECTOR));

    /** Beams. */
    public static final EnumSet<Shape> Beams = EnumSet.copyOf(Arrays.asList(BEAM, BEAM_SMALL,
                                                                            BEAM_HOOK,
                                                                            BEAM_HOOK_SMALL));
    ...
    //----------------------------------------------------------------------------------------------
    public static final ShapeSet Accidentals = new ShapeSet(SHARP, Colors.SCORE_MODIFIERS, shapesOf(
                                                            FLAT, NATURAL, SHARP, DOUBLE_SHARP,
                                                            DOUBLE_FLAT));

    public static final ShapeSet Articulations = new ShapeSet(ACCENT, Colors.SCORE_MODIFIERS,
                                                              shapesOf(ACCENT, TENUTO, STACCATO,
                                                                       STACCATISSIMO, STRONG_ACCENT));

    public static final ShapeSet Attributes = new ShapeSet(PEDAL_MARK, Colors.SCORE_MODIFIERS,
                                                           shapesOf(OTTAVA_ALTA, OTTAVA_BASSA,
    ...
    public static final ShapeSet Barlines = new ShapeSet(
            LEFT_REPEAT_SIGN,
            Colors.SCORE_FRAME,
            shapesOf(THIN_BARLINE, THICK_BARLINE, DOUBLE_BARLINE, FINAL_BARLINE,
                     REVERSE_FINAL_BARLINE, LEFT_REPEAT_SIGN, RIGHT_REPEAT_SIGN,
                     BACK_TO_BACK_REPEAT_SIGN, BRACE, BRACKET, REPEAT_DOT));

    public static final ShapeSet BeamsAndTuplets = new ShapeSet(BEAM, Colors.SCORE_NOTES, shapesOf(
                                                                BEAM /* ,BEAM_SMALL */,
                                                                BEAM_HOOK, TUPLET_THREE, TUPLET_SIX));

    public static final ShapeSet Clefs = new ShapeSet(G_CLEF, Colors.SCORE_FRAME, shapesOf(
                                                      TrebleClefs, BassClefs, shapesOf(C_CLEF,
                                                                                       PERCUSSION_CLEF)));

    public static final ShapeSet Dynamics = new ShapeSet(
            DYNAMICS_F,
            Colors.SCORE_MODIFIERS,
            shapesOf(DYNAMICS_P, DYNAMICS_PP, DYNAMICS_MP, DYNAMICS_F, DYNAMICS_FF, DYNAMICS_MF,
                     DYNAMICS_FP, DYNAMICS_SF, DYNAMICS_SFZ, CRESCENDO, DIMINUENDO));

    public static final ShapeSet Flags = new ShapeSet(FLAG_1, Colors.SCORE_NOTES, shapesOf(
                                                      new ArrayList<Shape>(FlagsDown), SmallFlags,
                                                      FlagsUp));

    public static final ShapeSet Holds = new ShapeSet(FERMATA, Colors.SCORE_MODIFIERS, shapesOf(
                                                      BREATH_MARK, CAESURA, FERMATA, FERMATA_BELOW));

    public static final ShapeSet Keys = new ShapeSet(KEY_SHARP_3, Colors.SCORE_MODIFIERS, shapesOf(
                                                     new ArrayList<Shape>(FlatKeys), SharpKeys));

    public static final ShapeSet HeadsAndDot = new ShapeSet(NOTEHEAD_BLACK, Colors.SCORE_NOTES,
                                                            shapesOf(Heads, shapesOf(
                                                                     AUGMENTATION_DOT)));

    public static final ShapeSet Markers = new ShapeSet(CODA, Colors.SCORE_FRAME,
                                                        shapesOf(DAL_SEGNO, DA_CAPO, SEGNO, CODA));

    public static final ShapeSet Ornaments = new ShapeSet(
            MORDENT,
            Colors.SCORE_MODIFIERS,
            shapesOf(GRACE_NOTE_SLASH, GRACE_NOTE, TR, TURN, TURN_INVERTED, TURN_UP, TURN_SLASH,
                     MORDENT, MORDENT_INVERTED));

    public static final ShapeSet Rests = new ShapeSet(
            QUARTER_REST,
            Colors.SCORE_NOTES,
            shapesOf(LONG_REST, BREVE_REST, WHOLE_REST, HALF_REST, QUARTER_REST, EIGHTH_REST,
                     ONE_16TH_REST, ONE_32ND_REST, ONE_64TH_REST, ONE_128TH_REST));

    public static final ShapeSet Times = new ShapeSet(TIME_FOUR_FOUR, Colors.SCORE_FRAME, shapesOf(
                                                      PartialTimes, WholeTimes)); //, shapesOf(TIME_ZERO, TIME_ONE, CUSTOM_TIME)));
    ...
    public static final ShapeSet Pluckings = new ShapeSet(PLUCK_P, Colors.SCORE_MODIFIERS, shapesOf(
                                                          PLUCK_P, PLUCK_I, PLUCK_M, PLUCK_A));

    public static final ShapeSet Romans = new ShapeSet(
            ROMAN_V,
            Colors.SCORE_MODIFIERS,
            shapesOf(ROMAN_I, ROMAN_II, ROMAN_III, ROMAN_IV, ROMAN_V, ROMAN_VI, ROMAN_VII,
                     ROMAN_VIII, ROMAN_IX, ROMAN_X, ROMAN_XI, ROMAN_XII));

    public static final ShapeSet Physicals = new ShapeSet(LEDGER, Colors.SCORE_PHYSICALS, shapesOf(
                                                          LYRICS, TEXT, CHARACTER, CLUTTER, SLUR,
                                                          LEDGER, STEM, ENDING));
    ...
    public static final EnumSet<Shape> allPhysicalShapes = EnumSet.range(Shape.values()[0],
                                                                         LAST_PHYSICAL_SHAPE);

    /** Symbols that can be attached to a stem. */
    public static final EnumSet<Shape> StemSymbols = EnumSet.copyOf(shapesOf(StemHeads, Flags
                                                                             .getShapes(), Beams));
    ...
    /** All variants of dot */
    public static final EnumSet<Shape> Dots = EnumSet.of(DOT_set, AUGMENTATION_DOT, STACCATO,
                                                         REPEAT_DOT);

    /** Clefs ottava (alta or bassa) */
    public static final EnumSet<Shape> OttavaClefs = EnumSet.of(G_CLEF_8VA, G_CLEF_8VB, F_CLEF_8VA,
                                                                F_CLEF_8VB);
    ...
    {
        final EnumSet<Shape> set = EnumSet.of(NOTEHEAD_BLACK, NOTEHEAD_VOID, WHOLE_NOTE,
                                              NOTEHEAD_BLACK_SMALL, NOTEHEAD_VOID_SMALL,
                                              WHOLE_NOTE_SMALL);
    ...
    {
        final EnumSet<Shape> set = EnumSet.of(NOTEHEAD_BLACK, NOTEHEAD_VOID, NOTEHEAD_BLACK_SMALL,
                                              NOTEHEAD_VOID_SMALL);
    ...
    {
        Collection<Shape> shapes = (col instanceof List) ? new ArrayList<Shape>() : EnumSet.noneOf(
                Shape.class);
    ...
    {
        Collection<Shape> shapes = (col1 instanceof List) ? new ArrayList<Shape>() : EnumSet.noneOf(
                Shape.class);
    ...
    private void setName (String name)
    {
        ...
        constantColor = new Constant.Color(getClass().getName(), name + ".color", Constant.Color
                                           .encodeColor(color), "Color code for set " + name);
